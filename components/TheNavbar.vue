    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          <!-- Mobile menu button-->
          <DisclosureButton
            class="relative inline-flex items-center justify-center rounded-md p-2 text-main hover:bg-main-2 hover:text-main-2 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
          >
        ...
        >
          <div class="flex-shrink-0 items-center sm:flex hidden">
            <CommonBrand :logo="true" />
          </div>
        ...
        >
          <CommonButton variant="main-2" class="sm:flex hidden"
            >Iniciar Sesión</CommonButton
          >

          <div
            class="h-8 w-[1px] mx-3 rounded-full bg-[#333] sm:block hidden"
          ></div>
      ...
      <div class="space-y-1 px-2 pb-3 pt-2">
        <DisclosureButton
          ...
          :class="[
            ...
            'block rounded-md px-3 py-2 pb-4 text-base font-semibold',
          ]"
          :aria-current="item.current ? 'page' : undefined"
          >{{ item.name }}</DisclosureButton
        >

        <CommonButton variant="main-2">Iniciar Sesión</CommonButton>
      </div>
    </DisclosurePanel>
  </Disclosure>
</template>
